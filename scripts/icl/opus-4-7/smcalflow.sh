...
TEST="data/smcalflow/test.json"
TRAIN_PLAIN="data/smcalflow/train.json"
TRAIN_COT="data/smcalflow/train_balanced_cot.json"
PRED_GRAMMAR="outputs/predicted_grammars/rag_cot/smcalflow_test_k64.json"

OUT_DIR="outputs/icl/${MODEL_ALIAS}/smcalflow"
RES_DIR="results/icl/${MODEL_ALIAS}/smcalflow"
...
uv run python src/icl.py plot \
    ...
    --title "SMCalFlow — ${MODEL_ALIAS} (k=${K})"
