...
TEST="data/overnight/test.json"
TRAIN_PLAIN="data/overnight/train.json"
TRAIN_COT="data/overnight/train_cot.json"
PRED_GRAMMAR="outputs/predicted_grammars/rag_cot/overnight_test_k64.json"

OUT_DIR="outputs/icl/${MODEL_ALIAS}/overnight"
RES_DIR="results/icl/${MODEL_ALIAS}/overnight"
...
uv run python src/icl.py plot \
    ...
    --title "Overnight-Blocks — ${MODEL_ALIAS} (k=${K})"
