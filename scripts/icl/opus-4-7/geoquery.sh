...
TEST="data/geoquery/test.json"
TRAIN_PLAIN="data/geoquery/train.json"
TRAIN_COT="data/geoquery/train_cot.json"
PRED_GRAMMAR="outputs/predicted_grammars/rag_cot/geoquery_test_k64.json"

OUT_DIR="outputs/icl/${MODEL_ALIAS}/geoquery"
RES_DIR="results/icl/${MODEL_ALIAS}/geoquery"
...
uv run python src/icl.py plot \
    ...
    --title "GeoQuery — ${MODEL_ALIAS} (k=${K})"
