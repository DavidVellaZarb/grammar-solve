...
RESULTS_DIR="results/ablations/p10/add_rule_p10"

uv run python src/train.py \
    --train_path "data/smcalflow/ablations/train_add_rule_p10.json" \
...
uv run python src/plot.py \
    --results_dir results/ablations/p10 \
    --models '["add_rule_p10"]' \
    --output_path results/ablations/p10/add_rule_p10/ablation_add_rule_p10.png \
...
RESULTS_DIR="results/ablations/p10/remove_rule_p10"

uv run python src/train.py \
    --train_path "data/smcalflow/ablations/train_remove_rule_p10.json" \
    --hub_model_id "$ADAPTER"
...
uv run python src/plot.py \
    ...
    --output_path results/ablations/p10/remove_rule_p10/ablation_remove_rule_p10.png \
...
RESULTS_DIR="results/ablations/p10/add_remove_rule_p10"

uv run python src/train.py \
    --train_path "data/smcalflow/ablations/train_add_remove_rule_p10.json" \
    --hub_model_id "$ADAPTER"
...
uv run python src/plot.py \
    ...
    --output_path results/ablations/p10/add_remove_rule_p10/ablation_add_remove_rule_p10.png \
