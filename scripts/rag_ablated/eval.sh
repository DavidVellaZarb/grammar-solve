...
uv run python src/plot.py plot_bar_chart \
    ...
    --reference_lines '[{"value_from": "results/baseline/baseline.json", "metric": "accuracy", "label": "Baseline (no grammar)", "style": "dotted", "color": "gray"}, {"value_from": "results/ablations/p20/add_remove_rule_p20/test.json", "metric": "accuracy", "label": "Gold grammar", "style": "dashed", "color": "green"}]' \
