...
RESULT_DIR="results/geoquery/${MODEL_ALIAS}"
PRED_DIR=outputs/predicted_grammars/rag_cot

BASELINE_ADAPTER="${HF_NAMESPACE}/${MODEL_ALIAS}_geoquery-baseline"
OURS_ADAPTER="${HF_NAMESPACE}/${MODEL_ALIAS}_geoquery-mixed-r0.1"
