...
BASE_URL = "https://raw.githubusercontent.com/berlino/grammar-prompting/main/data/overnight/blocks"
...
def _extract_grammar(program: str, parser) -> str | None:
    ...
    _walk_tree(tree, rules, position_aware_spacing=True)
...
def load(
    ...
    print("Building Overnight-Blocks parser...")
    with open(GRAMMAR_PATH) as f:
        grammar_text = f.read()
    parser = Lark(grammar_text, start="list_value", parser="earley", keep_all_tokens=True)
